...
// ============================================================================
// SECTION-BASED SCENE BREAKDOWN - Organic scene creation with no target count
// ============================================================================
...
**Pacing phase: ${pacingPhase.toUpperCase()}**
- Scene durations should be ${durationRange}
- Maximum ~${maxWordsPerScene} words per scene's script_snippet
- If a sentence exceeds ${maxWordsPerScene} words, SPLIT it into multiple scenes at natural breakpoints
...
- Split text at natural breakpoints (periods, commas, em-dashes, semicolons) when it exceeds ~${maxWordsPerScene} words
